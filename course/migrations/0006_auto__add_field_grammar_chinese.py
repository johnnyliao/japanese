...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grammar.chinese'
        db.add_column(u'course_grammar', 'chinese',
                      self.gf('django.db.models.fields.CharField')(default=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grammar.chinese'
        db.delete_column(u'course_grammar', 'chinese')
